package com.ingsha.captcha;

import com.ingsha.captcha.base.ArithmeticCaptchaAbstract;
...
public class ArithmeticCaptcha extends ArithmeticCaptchaAbstract {
    ...
    private static final Logger LOGGER = Logger.getLogger(ArithmeticCaptcha.class);
